...
<style>
  * { box-sizing: border-box; margin: 0; }
  ...
  .btn { display: inline-block; background: #fff; border: 1px solid rgba(0,0,0,.12); border-radius: 10px; padding: 9px 14px; font-size: 13.5px; font-weight: 600; color: #1D1D1F; text-decoration: none; margin-bottom: 16px; }
...
<body>
  ...
  <a class="btn" href="?key=${esc(key)}&csv=1">Скачать всё таблицей (CSV)</a>
  <div class="stats">
